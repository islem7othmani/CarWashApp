...
function StationInfos() {
  return (
    <>
    <div class="flex items-center justify-center p-12 relatve  bg-gray-50">
    
    <div class="mx-auto w-full max-w-[550px] relative -top-6 bg-gray-50">
        <form>
            <div class="mb-5">
