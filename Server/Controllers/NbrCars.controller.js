...
const addNbCars = async (req, res) => {
    try {
        const { nbr, waittimeSI, waittimeME, waittimeLIE, station } = req.body;
...
const getNbr = async (req, res) => {
    try {
        ...
        console.log("Nbcars Document:", JSON.stringify(nbcar, null, 2));
        ...
        console.log("Aggregated Result:", JSON.stringify(nbr, null, 2));
